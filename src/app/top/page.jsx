        ...
        <div className='flex flex-col'>
            <section className='my-2'>
                <Encabezado
                    title={'Bebidas'}
                    route={'/drinks'}
                    icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#fff" className="h-4 mr-2 my-2">
                ...
                />
                <div className="overflow-y-scroll font-semibold text-center grid grid-cols-4 gap-44 mx-2">
                    <ItemCard
                        title={'Café'}
                        image={'cafe.jpg'}
            ...
            <section className='my-2'>
                <Encabezado
                    ...
                    route={'/food'}
                    icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#fff" className="h-4 mr-2 my-2">
